...
const About = () => {
   return (
      <div id='about_section' className='container about' style={{ marginTop: '200px' }}>
         <div className="row">
            <div className="col-md-7 text-start">
               <h2 style={{ color: '#FFFF14', fontSize: '64px' }}>About Us</h2>
               <p className='text-white para_content'>Bit Royale (<span className='royal'>"Royale"</span>) is the most promising NFT game of 2022. In it you can purchase your <span className='royal'>"Royale"</span> tokens and use them to get your NFT heroes, trainers and Lands to play our P2E game.
